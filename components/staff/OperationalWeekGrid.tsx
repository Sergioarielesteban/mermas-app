  ...
  return (
    <div className="space-y-2">
      ...
      <div className="overflow-x-auto rounded-2xl ring-1 ring-zinc-200/90">
        <table className="w-full min-w-[960px] border-collapse text-left text-[10px] sm:min-w-[1040px] sm:text-xs">
          <thead>
              ...
              {days.map((d) => {
                ...
                return (
                  <th
                    key={ymd}
                    className={[
                      'min-w-[7.25rem] border-b border-zinc-200 px-0.5 py-1.5 text-center font-extrabold sm:min-w-[8.25rem] sm:px-1',
                      headerTone(cov),
                    ].join(' ')}
                  >
            ...
            <tr className="bg-zinc-50/95">
              ...
              {days.map((d) => {
                ...
                return (
                  <th
                    key={`tl-${ymd}`}
                    className="min-w-[7.25rem] border-b border-zinc-200 bg-zinc-50/90 align-top sm:min-w-[8.25rem]"
                  >
