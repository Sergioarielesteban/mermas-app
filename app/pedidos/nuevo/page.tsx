          ...
          {filteredProducts.map((p) => {
            ...
            return (
              <div key={p.id} className="rounded-xl bg-zinc-50 p-3 ring-1 ring-zinc-200">
                ...
                <div className="mt-3 grid grid-cols-[2.5rem_3rem_2.5rem_3.5rem] items-center justify-end gap-2">
                  <button
                    type="button"
                  ...
                  <input
                    ...
                    className="h-10 w-12 shrink-0 rounded-lg border border-zinc-300 bg-white px-1 text-center text-sm font-semibold text-zinc-700 outline-none [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                  ...
                  <span className="w-14 text-left text-xs font-semibold uppercase text-zinc-500">{p.unit}</span>
                </div>
              </div>
            );
          })}
