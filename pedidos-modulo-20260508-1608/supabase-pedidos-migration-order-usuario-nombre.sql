-- Pedidos: nombre visible de quien crea/envía el pedido (cabecera purchase_orders).

alter table public.purchase_orders
  add column if not exists usuario_nombre text;

comment on column public.purchase_orders.usuario_nombre is 'Nombre legible del usuario que guardó o envió el pedido (texto libre; opcional).';
