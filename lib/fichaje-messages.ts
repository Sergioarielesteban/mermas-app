...
export const fichajeMessages = {
  clockIn: [
    ...
    'Hoy los tickets vienen arrechos, pero nosotros más. No joda!!!',
    ...
    'Pilas con la estación, que los primeros tickets ya casi caen.',
    ...
    'Vamos con todo, que los tickets cantan y nosotros bailamos. No joda!!!',
    ...
    'Coño, arranca el turno: menos cuento, más fuego. No joda!!!',
  ...
  clockOut: [
    'Coño, hoy sí estuvo arrecho. Buen trabajo, de pana. No joda!!!',
    ...
    'Coño, qué servicio tan bravo... y lo sacaste. No joda!!!',
    ...
    'Coño, digno de aplauso silencioso ese cierre. Qué locura tan buena.',
